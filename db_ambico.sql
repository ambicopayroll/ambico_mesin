...
--
-- Host: localhost
-- Generation Time: Mar 08, 2017 at 02:08 PM
...
(1, '2017-03-08 05:33:44', '/ambico/login.php', 'admin', 'login', '::1', '', '', '', '');
...
('2251016030265', '8740A-CAD2-D7980-B561-9269C-992F-AAD64', NULL, 'Mesin 1', 0, 1, 0, '192.168.1.201', 6, 3, '', '', '5500', 0, 10, 0, 0, '2017-03-08', '0', '0', '0');
...
CREATE TABLE IF NOT EXISTS `pegawai` (
  ...
  `pegawai_pwd` varchar(10) NOT NULL DEFAULT '',
  `pegawai_rfid` varchar(32) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `pegawai_d` (
  ...
  `pend_id` int(10) NOT NULL DEFAULT '30',
...
('admin', '2017-03-08 12:05:00', 5, 1, '', 'Login user aplikasi "admin" '),
('admin', '2017-03-08 12:05:00', 5, 1, '', 'Login user aplikasi "admin" '),
('admin', '2017-03-08 12:05:00', 5, 2, '', 'Mengubah pengaturan umum'),
('admin', '2017-03-08 12:05:00', 5, 2, '', 'Mengubah pengaturan umum'),
('admin', '2017-03-08 12:06:00', 5, 1, '', 'Login user aplikasi "admin" ');
...
('admin', '455CB4D4A6D53E8C2F7094B1B764184A', 1, '2017-03-08 00:00:00', 'admin'),
