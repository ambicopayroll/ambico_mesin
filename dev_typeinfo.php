...
//
// Table class for dev_type
//
class cdev_type extends cTable {
	var $dev_type;
	var $id_type;
	var $type;
	...
	function __construct() {
		...
		$this->TableVar = 'dev_type';
		$this->TableName = 'dev_type';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`dev_type`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// dev_type
		$this->dev_type = new cField('dev_type', 'dev_type', 'x_dev_type', 'dev_type', '`dev_type`', '`dev_type`', 3, -1, FALSE, '`dev_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_type
		$this->id_type = new cField('dev_type', 'dev_type', 'x_id_type', 'id_type', '`id_type`', '`id_type`', 3, -1, FALSE, '`id_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new cField('dev_type', 'dev_type', 'x_type', 'type', '`type`', '`type`', 200, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`dev_type`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("dev_typeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("dev_typeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "dev_typeadd.php?" . $this->UrlParm($parm);
		else
			$url = "dev_typeadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("dev_typeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("dev_typeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("dev_typedelete.php", $this->UrlParm());
	}
