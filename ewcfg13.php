...
define("EW_RANDOM_KEY", '4xGq8adyPK08sj3J', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_ambico", "qs" => "`", "qe" => "`");
