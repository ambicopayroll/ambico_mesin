...
$RootMenu->AddMenuItem(32, "mi_pembagian2", $Language->MenuPhrase("32", "MenuText"), "pembagian2list.php", 233, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}pembagian2'), FALSE, FALSE);
$RootMenu->AddMenuItem(33, "mi_pembagian3", $Language->MenuPhrase("33", "MenuText"), "pembagian3list.php", 233, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}pembagian3'), FALSE, FALSE);
$RootMenu->AddMenuItem(36, "mi_shift_result", $Language->MenuPhrase("36", "MenuText"), "shift_resultlist.php", 233, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}shift_result'), FALSE, FALSE);
$RootMenu->AddMenuItem(25, "mi_kategori_izin", $Language->MenuPhrase("25", "MenuText"), "kategori_izinlist.php", 233, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}kategori_izin'), FALSE, FALSE);
$RootMenu->AddMenuItem(13, "mi_grp_user_d", $Language->MenuPhrase("13", "MenuText"), "grp_user_dlist.php", 233, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}grp_user_d'), FALSE, FALSE);
$RootMenu->AddMenuItem(14, "mi_grp_user_m", $Language->MenuPhrase("14", "MenuText"), "grp_user_mlist.php", 233, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}grp_user_m'), FALSE, FALSE);
...
$RootMenu->AddMenuItem(1, "mi_att_log", $Language->MenuPhrase("1", "MenuText"), "att_loglist.php", 127, "", AllowListMenu('{0B4A4F9E-7A2B-4234-9791-3975C1DCDDA1}att_log'), FALSE, FALSE);
