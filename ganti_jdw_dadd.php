...
$ganti_jdw_d_add = NULL; // Initialize page object first

class cganti_jdw_d_add extends cganti_jdw_d {
	...
	// Page object name
	var $PageObjName = 'ganti_jdw_d_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["tgl_ganti_jdw"] != "") {
				...
				$this->setKey("tgl_ganti_jdw", $this->tgl_ganti_jdw->CurrentValue); // Set up key
			} else {
				$this->setKey("tgl_ganti_jdw", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if (@$_GET["jns_ganti_jdw"] != "") {
				$this->jns_ganti_jdw->setQueryStringValue($_GET["jns_ganti_jdw"]);
				$this->setKey("jns_ganti_jdw", $this->jns_ganti_jdw->CurrentValue); // Set up key
			} else {
				$this->setKey("jns_ganti_jdw", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ganti_jdw_dview.php")
	...
	function LoadDefaultValues() {
		...
		$this->tgl_ganti_jdw->CurrentValue = NULL;
		$this->tgl_ganti_jdw->OldValue = $this->tgl_ganti_jdw->CurrentValue;
		$this->jns_ganti_jdw->CurrentValue = NULL;
		$this->jns_ganti_jdw->OldValue = $this->jns_ganti_jdw->CurrentValue;
	...
	function RenderRow() {
		...
		$this->pegawai_id->ViewCustomAttributes = "";
			...
			$this->tgl_ganti_jdw->EditValue = ew_HtmlEncode(ew_FormatDateTime($this->tgl_ganti_jdw->CurrentValue, 8));
			$this->tgl_ganti_jdw->PlaceHolder = ew_RemoveHtml($this->tgl_ganti_jdw->FldCaption());

			// jns_ganti_jdw
			$this->jns_ganti_jdw->EditAttrs["class"] = "form-control";
			$this->jns_ganti_jdw->EditCustomAttributes = "";
			$this->jns_ganti_jdw->EditValue = ew_HtmlEncode($this->jns_ganti_jdw->CurrentValue);
			$this->jns_ganti_jdw->PlaceHolder = ew_RemoveHtml($this->jns_ganti_jdw->FldCaption());
	...
	function AddRow($rsold = NULL) {
		...
		// tgl_ganti_jdw
		$this->tgl_ganti_jdw->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_ganti_jdw->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// jns_ganti_jdw
		$this->jns_ganti_jdw->SetDbValueDef($rsnew, $this->jns_ganti_jdw->CurrentValue, 0, FALSE);
		...
		// Check if key value entered
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['tgl_ganti_jdw']) == "") {
			$this->setFailureMessage($Language->Phrase("InvalidKeyValue"));
			$bInsertRow = FALSE;
		}

		// Check if key value entered
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['jns_ganti_jdw']) == "") {
			$this->setFailureMessage($Language->Phrase("InvalidKeyValue"));
			$bInsertRow = FALSE;
		}
...
// Create page object
if (!isset($ganti_jdw_d_add)) $ganti_jdw_d_add = new cganti_jdw_d_add();

// Page init
$ganti_jdw_d_add->Page_Init();

// Page main
$ganti_jdw_d_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ganti_jdw_d_add->Page_Render();
?>
...
var CurrentForm = fganti_jdw_dadd = new ew_Form("fganti_jdw_dadd", "add");

// Validate form
fganti_jdw_dadd.Validate = function() {
...
fganti_jdw_dadd.Form_CustomValidate = 
...
fganti_jdw_dadd.ValidateRequired = true;
<?php } else { ?>
fganti_jdw_dadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$ganti_jdw_d_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $ganti_jdw_d_add->ShowPageHeader(); ?>
<?php
$ganti_jdw_d_add->ShowMessage();
?>
<form name="fganti_jdw_dadd" id="fganti_jdw_dadd" class="<?php echo $ganti_jdw_d_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ganti_jdw_d_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ganti_jdw_d_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="ganti_jdw_d" data-field="x_ganti_jdw_id" name="x_ganti_jdw_id" id="x_ganti_jdw_id" size="30" placeholder="<?php echo ew_HtmlEncode($ganti_jdw_d->ganti_jdw_id->getPlaceHolder()) ?>" value="<?php echo $ganti_jdw_d->ganti_jdw_id->EditValue ?>"<?php echo $ganti_jdw_d->ganti_jdw_id->EditAttributes() ?>>
</span>
...
<input type="text" data-table="ganti_jdw_d" data-field="x_tgl_ganti_jdw" name="x_tgl_ganti_jdw" id="x_tgl_ganti_jdw" placeholder="<?php echo ew_HtmlEncode($ganti_jdw_d->tgl_ganti_jdw->getPlaceHolder()) ?>" value="<?php echo $ganti_jdw_d->tgl_ganti_jdw->EditValue ?>"<?php echo $ganti_jdw_d->tgl_ganti_jdw->EditAttributes() ?>>
</span>
...
<input type="text" data-table="ganti_jdw_d" data-field="x_jns_ganti_jdw" name="x_jns_ganti_jdw" id="x_jns_ganti_jdw" size="30" placeholder="<?php echo ew_HtmlEncode($ganti_jdw_d->jns_ganti_jdw->getPlaceHolder()) ?>" value="<?php echo $ganti_jdw_d->jns_ganti_jdw->EditValue ?>"<?php echo $ganti_jdw_d->jns_ganti_jdw->EditAttributes() ?>>
</span>
...
<input type="text" data-table="ganti_jdw_d" data-field="x_jdw_kerja_m_id" name="x_jdw_kerja_m_id" id="x_jdw_kerja_m_id" size="30" placeholder="<?php echo ew_HtmlEncode($ganti_jdw_d->jdw_kerja_m_id->getPlaceHolder()) ?>" value="<?php echo $ganti_jdw_d->jdw_kerja_m_id->EditValue ?>"<?php echo $ganti_jdw_d->jdw_kerja_m_id->EditAttributes() ?>>
</span>
...
<input type="text" data-table="ganti_jdw_d" data-field="x_pegawai_id" name="x_pegawai_id" id="x_pegawai_id" size="30" placeholder="<?php echo ew_HtmlEncode($ganti_jdw_d->pegawai_id->getPlaceHolder()) ?>" value="<?php echo $ganti_jdw_d->pegawai_id->EditValue ?>"<?php echo $ganti_jdw_d->pegawai_id->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ganti_jdw_d_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fganti_jdw_dadd.Init();
</script>
<?php
$ganti_jdw_d_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ganti_jdw_d_add->Page_Terminate();
?>
