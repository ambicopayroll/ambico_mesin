...
$ganti_jdw_jk_edit = NULL; // Initialize page object first

class cganti_jdw_jk_edit extends cganti_jdw_jk {
	...
	// Page object name
	var $PageObjName = 'ganti_jdw_jk_edit';
	...
	function Page_Main() {
		...
		if ($this->ganti_jdw_id->CurrentValue == "") {
			$this->Page_Terminate("ganti_jdw_jklist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->jdw_kerja_m_id1->SetDbValueDef($rsnew, $this->jdw_kerja_m_id1->CurrentValue, 0, $this->jdw_kerja_m_id1->ReadOnly);

			// jdw_kerja_m_id2
			$this->jdw_kerja_m_id2->SetDbValueDef($rsnew, $this->jdw_kerja_m_id2->CurrentValue, 0, $this->jdw_kerja_m_id2->ReadOnly);
...
// Create page object
if (!isset($ganti_jdw_jk_edit)) $ganti_jdw_jk_edit = new cganti_jdw_jk_edit();

// Page init
$ganti_jdw_jk_edit->Page_Init();

// Page main
$ganti_jdw_jk_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ganti_jdw_jk_edit->Page_Render();
?>
...
var CurrentForm = fganti_jdw_jkedit = new ew_Form("fganti_jdw_jkedit", "edit");

// Validate form
fganti_jdw_jkedit.Validate = function() {
...
fganti_jdw_jkedit.Form_CustomValidate = 
...
fganti_jdw_jkedit.ValidateRequired = true;
<?php } else { ?>
fganti_jdw_jkedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$ganti_jdw_jk_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $ganti_jdw_jk_edit->ShowPageHeader(); ?>
<?php
$ganti_jdw_jk_edit->ShowMessage();
?>
<form name="fganti_jdw_jkedit" id="fganti_jdw_jkedit" class="<?php echo $ganti_jdw_jk_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ganti_jdw_jk_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ganti_jdw_jk_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $ganti_jdw_jk->ganti_jdw_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ganti_jdw_jk" data-field="x_ganti_jdw_id" name="x_ganti_jdw_id" id="x_ganti_jdw_id" value="<?php echo ew_HtmlEncode($ganti_jdw_jk->ganti_jdw_id->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ganti_jdw_jk_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fganti_jdw_jkedit.Init();
</script>
<?php
$ganti_jdw_jk_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ganti_jdw_jk_edit->Page_Terminate();
?>
