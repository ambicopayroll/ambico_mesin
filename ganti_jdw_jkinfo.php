...
//
// Table class for ganti_jdw_jk
//
class cganti_jdw_jk extends cTable {
	var $ganti_jdw_id;
	var $jdw_kerja_m_id1;
	var $jdw_kerja_m_id2;
	var $tgl_awal;
	...
	function __construct() {
		...
		$this->TableVar = 'ganti_jdw_jk';
		$this->TableName = 'ganti_jdw_jk';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ganti_jdw_jk`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ganti_jdw_id
		$this->ganti_jdw_id = new cField('ganti_jdw_jk', 'ganti_jdw_jk', 'x_ganti_jdw_id', 'ganti_jdw_id', '`ganti_jdw_id`', '`ganti_jdw_id`', 3, -1, FALSE, '`ganti_jdw_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jdw_kerja_m_id1
		$this->jdw_kerja_m_id1 = new cField('ganti_jdw_jk', 'ganti_jdw_jk', 'x_jdw_kerja_m_id1', 'jdw_kerja_m_id1', '`jdw_kerja_m_id1`', '`jdw_kerja_m_id1`', 3, -1, FALSE, '`jdw_kerja_m_id1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jdw_kerja_m_id1->Sortable = TRUE; // Allow sort
		$this->jdw_kerja_m_id1->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['jdw_kerja_m_id1'] = &$this->jdw_kerja_m_id1;

		// jdw_kerja_m_id2
		$this->jdw_kerja_m_id2 = new cField('ganti_jdw_jk', 'ganti_jdw_jk', 'x_jdw_kerja_m_id2', 'jdw_kerja_m_id2', '`jdw_kerja_m_id2`', '`jdw_kerja_m_id2`', 3, -1, FALSE, '`jdw_kerja_m_id2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jdw_kerja_m_id2->Sortable = TRUE; // Allow sort
		$this->jdw_kerja_m_id2->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['jdw_kerja_m_id2'] = &$this->jdw_kerja_m_id2;

		// tgl_awal
		$this->tgl_awal = new cField('ganti_jdw_jk', 'ganti_jdw_jk', 'x_tgl_awal', 'tgl_awal', '`tgl_awal`', ew_CastDateFieldForLike('`tgl_awal`', 0, "DB"), 133, 0, FALSE, '`tgl_awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_akhir
		$this->tgl_akhir = new cField('ganti_jdw_jk', 'ganti_jdw_jk', 'x_tgl_akhir', 'tgl_akhir', '`tgl_akhir`', ew_CastDateFieldForLike('`tgl_akhir`', 0, "DB"), 133, 0, FALSE, '`tgl_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new cField('ganti_jdw_jk', 'ganti_jdw_jk', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ganti_jdw_jk`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ganti_jdw_jkview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ganti_jdw_jkview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ganti_jdw_jkadd.php?" . $this->UrlParm($parm);
		else
			$url = "ganti_jdw_jkadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jdw_jkedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jdw_jkadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ganti_jdw_jkdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->jdw_kerja_m_id1->EditValue = $this->jdw_kerja_m_id1->CurrentValue;
		...
		$this->jdw_kerja_m_id2->EditValue = $this->jdw_kerja_m_id2->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->jdw_kerja_m_id1->Exportable) $Doc->ExportCaption($this->jdw_kerja_m_id1);
					if ($this->jdw_kerja_m_id2->Exportable) $Doc->ExportCaption($this->jdw_kerja_m_id2);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->jdw_kerja_m_id1->Exportable) $Doc->ExportField($this->jdw_kerja_m_id1);
						if ($this->jdw_kerja_m_id2->Exportable) $Doc->ExportField($this->jdw_kerja_m_id2);
