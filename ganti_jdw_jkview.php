...
$ganti_jdw_jk_view = NULL; // Initialize page object first

class cganti_jdw_jk_view extends cganti_jdw_jk {
	...
	// Page object name
	var $PageObjName = 'ganti_jdw_jk_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ganti_jdw_id"] <> "") {
				...
				$sReturnUrl = "ganti_jdw_jklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "ganti_jdw_jklist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "ganti_jdw_jklist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($ganti_jdw_jk_view)) $ganti_jdw_jk_view = new cganti_jdw_jk_view();

// Page init
$ganti_jdw_jk_view->Page_Init();

// Page main
$ganti_jdw_jk_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ganti_jdw_jk_view->Page_Render();
?>
...
var CurrentForm = fganti_jdw_jkview = new ew_Form("fganti_jdw_jkview", "view");

// Form_CustomValidate event
fganti_jdw_jkview.Form_CustomValidate = 
...
fganti_jdw_jkview.ValidateRequired = true;
<?php } else { ?>
fganti_jdw_jkview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($ganti_jdw_jk->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$ganti_jdw_jk_view->IsModal) { ?>
<?php if ($ganti_jdw_jk->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $ganti_jdw_jk_view->ExportOptions->Render("body") ?>
<?php
	foreach ($ganti_jdw_jk_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$ganti_jdw_jk_view->IsModal) { ?>
<?php if ($ganti_jdw_jk->Export == "") { ?>
...
<?php } ?>
<?php $ganti_jdw_jk_view->ShowPageHeader(); ?>
<?php
$ganti_jdw_jk_view->ShowMessage();
?>
<form name="fganti_jdw_jkview" id="fganti_jdw_jkview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ganti_jdw_jk_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ganti_jdw_jk_view->Token ?>">
<?php } ?>
...
<?php if ($ganti_jdw_jk->ganti_jdw_id->Visible) { // ganti_jdw_id ?>
	<tr id="r_ganti_jdw_id">
		<td><span id="elh_ganti_jdw_jk_ganti_jdw_id"><?php echo $ganti_jdw_jk->ganti_jdw_id->FldCaption() ?></span></td>
...
<?php echo $ganti_jdw_jk->ganti_jdw_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jdw_jk->jdw_kerja_m_id1->Visible) { // jdw_kerja_m_id1 ?>
	<tr id="r_jdw_kerja_m_id1">
		<td><span id="elh_ganti_jdw_jk_jdw_kerja_m_id1"><?php echo $ganti_jdw_jk->jdw_kerja_m_id1->FldCaption() ?></span></td>
...
<?php echo $ganti_jdw_jk->jdw_kerja_m_id1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jdw_jk->jdw_kerja_m_id2->Visible) { // jdw_kerja_m_id2 ?>
	<tr id="r_jdw_kerja_m_id2">
		<td><span id="elh_ganti_jdw_jk_jdw_kerja_m_id2"><?php echo $ganti_jdw_jk->jdw_kerja_m_id2->FldCaption() ?></span></td>
...
<?php echo $ganti_jdw_jk->jdw_kerja_m_id2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jdw_jk->tgl_awal->Visible) { // tgl_awal ?>
	<tr id="r_tgl_awal">
		<td><span id="elh_ganti_jdw_jk_tgl_awal"><?php echo $ganti_jdw_jk->tgl_awal->FldCaption() ?></span></td>
...
<?php echo $ganti_jdw_jk->tgl_awal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jdw_jk->tgl_akhir->Visible) { // tgl_akhir ?>
	<tr id="r_tgl_akhir">
		<td><span id="elh_ganti_jdw_jk_tgl_akhir"><?php echo $ganti_jdw_jk->tgl_akhir->FldCaption() ?></span></td>
...
<?php echo $ganti_jdw_jk->tgl_akhir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jdw_jk->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_ganti_jdw_jk_keterangan"><?php echo $ganti_jdw_jk->keterangan->FldCaption() ?></span></td>
...
<?php echo $ganti_jdw_jk->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($ganti_jdw_jk->Export == "") { ?>
<script type="text/javascript">
fganti_jdw_jkview.Init();
</script>
<?php } ?>
<?php
$ganti_jdw_jk_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($ganti_jdw_jk->Export == "") { ?>
...
<?php
$ganti_jdw_jk_view->Page_Terminate();
?>
