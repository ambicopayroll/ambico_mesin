...
$ganti_jdw_pegawai_add = NULL; // Initialize page object first

class cganti_jdw_pegawai_add extends cganti_jdw_pegawai {
	...
	// Page object name
	var $PageObjName = 'ganti_jdw_pegawai_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ganti_jdw_pegawaiview.php")
...
// Create page object
if (!isset($ganti_jdw_pegawai_add)) $ganti_jdw_pegawai_add = new cganti_jdw_pegawai_add();

// Page init
$ganti_jdw_pegawai_add->Page_Init();

// Page main
$ganti_jdw_pegawai_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ganti_jdw_pegawai_add->Page_Render();
?>
...
var CurrentForm = fganti_jdw_pegawaiadd = new ew_Form("fganti_jdw_pegawaiadd", "add");

// Validate form
fganti_jdw_pegawaiadd.Validate = function() {
...
fganti_jdw_pegawaiadd.Form_CustomValidate = 
...
fganti_jdw_pegawaiadd.ValidateRequired = true;
<?php } else { ?>
fganti_jdw_pegawaiadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$ganti_jdw_pegawai_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $ganti_jdw_pegawai_add->ShowPageHeader(); ?>
<?php
$ganti_jdw_pegawai_add->ShowMessage();
?>
<form name="fganti_jdw_pegawaiadd" id="fganti_jdw_pegawaiadd" class="<?php echo $ganti_jdw_pegawai_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ganti_jdw_pegawai_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ganti_jdw_pegawai_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="ganti_jdw_pegawai" data-field="x_ganti_jdw_id" name="x_ganti_jdw_id" id="x_ganti_jdw_id" size="30" placeholder="<?php echo ew_HtmlEncode($ganti_jdw_pegawai->ganti_jdw_id->getPlaceHolder()) ?>" value="<?php echo $ganti_jdw_pegawai->ganti_jdw_id->EditValue ?>"<?php echo $ganti_jdw_pegawai->ganti_jdw_id->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ganti_jdw_pegawai_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fganti_jdw_pegawaiadd.Init();
</script>
<?php
$ganti_jdw_pegawai_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ganti_jdw_pegawai_add->Page_Terminate();
?>
