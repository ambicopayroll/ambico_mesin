...
$ganti_jdw_pegawai = NULL;

//
// Table class for ganti_jdw_pegawai
//
class cganti_jdw_pegawai extends cTable {
	var $ganti_jdw_id;
	var $pegawai_id;
	var $tgl_awal;
	var $tgl_akhir;
	...
	function __construct() {
		...
		$this->TableVar = 'ganti_jdw_pegawai';
		$this->TableName = 'ganti_jdw_pegawai';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ganti_jdw_pegawai`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ganti_jdw_id
		$this->ganti_jdw_id = new cField('ganti_jdw_pegawai', 'ganti_jdw_pegawai', 'x_ganti_jdw_id', 'ganti_jdw_id', '`ganti_jdw_id`', '`ganti_jdw_id`', 3, -1, FALSE, '`ganti_jdw_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai_id
		$this->pegawai_id = new cField('ganti_jdw_pegawai', 'ganti_jdw_pegawai', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 3, -1, FALSE, '`pegawai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_awal
		$this->tgl_awal = new cField('ganti_jdw_pegawai', 'ganti_jdw_pegawai', 'x_tgl_awal', 'tgl_awal', '`tgl_awal`', ew_CastDateFieldForLike('`tgl_awal`', 0, "DB"), 133, 0, FALSE, '`tgl_awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_akhir
		$this->tgl_akhir = new cField('ganti_jdw_pegawai', 'ganti_jdw_pegawai', 'x_tgl_akhir', 'tgl_akhir', '`tgl_akhir`', ew_CastDateFieldForLike('`tgl_akhir`', 0, "DB"), 133, 0, FALSE, '`tgl_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jdw_kerja_m_id
		$this->jdw_kerja_m_id = new cField('ganti_jdw_pegawai', 'ganti_jdw_pegawai', 'x_jdw_kerja_m_id', 'jdw_kerja_m_id', '`jdw_kerja_m_id`', '`jdw_kerja_m_id`', 3, -1, FALSE, '`jdw_kerja_m_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new cField('ganti_jdw_pegawai', 'ganti_jdw_pegawai', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ganti_jdw_pegawai`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ganti_jdw_pegawailist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ganti_jdw_pegawaiview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ganti_jdw_pegawaiview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ganti_jdw_pegawaiadd.php?" . $this->UrlParm($parm);
		else
			$url = "ganti_jdw_pegawaiadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jdw_pegawaiedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jdw_pegawaiadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ganti_jdw_pegawaidelete.php", $this->UrlParm());
	}
