...
$ganti_jk_d_edit = NULL; // Initialize page object first

class cganti_jk_d_edit extends cganti_jk_d {
	...
	// Page object name
	var $PageObjName = 'ganti_jk_d_edit';
	...
	function Page_Main() {
		...
		if ($this->ganti_jk_id->CurrentValue == "") {
			$this->Page_Terminate("ganti_jk_dlist.php"); // Invalid key, return to list
		}
		if ($this->tgl_ganti_jk->CurrentValue == "") {
			$this->Page_Terminate("ganti_jk_dlist.php"); // Invalid key, return to list
		}
		if ($this->jns_ganti_jk->CurrentValue == "") {
			$this->Page_Terminate("ganti_jk_dlist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->libur->SetDbValueDef($rsnew, $this->libur->CurrentValue, 0, $this->libur->ReadOnly);
...
// Create page object
if (!isset($ganti_jk_d_edit)) $ganti_jk_d_edit = new cganti_jk_d_edit();

// Page init
$ganti_jk_d_edit->Page_Init();

// Page main
$ganti_jk_d_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ganti_jk_d_edit->Page_Render();
?>
...
var CurrentForm = fganti_jk_dedit = new ew_Form("fganti_jk_dedit", "edit");

// Validate form
fganti_jk_dedit.Validate = function() {
...
fganti_jk_dedit.Form_CustomValidate = 
...
fganti_jk_dedit.ValidateRequired = true;
<?php } else { ?>
fganti_jk_dedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$ganti_jk_d_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $ganti_jk_d_edit->ShowPageHeader(); ?>
<?php
$ganti_jk_d_edit->ShowMessage();
?>
<form name="fganti_jk_dedit" id="fganti_jk_dedit" class="<?php echo $ganti_jk_d_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ganti_jk_d_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ganti_jk_d_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $ganti_jk_d->ganti_jk_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ganti_jk_d" data-field="x_ganti_jk_id" name="x_ganti_jk_id" id="x_ganti_jk_id" value="<?php echo ew_HtmlEncode($ganti_jk_d->ganti_jk_id->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $ganti_jk_d->tgl_ganti_jk->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ganti_jk_d" data-field="x_tgl_ganti_jk" name="x_tgl_ganti_jk" id="x_tgl_ganti_jk" value="<?php echo ew_HtmlEncode($ganti_jk_d->tgl_ganti_jk->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $ganti_jk_d->jns_ganti_jk->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ganti_jk_d" data-field="x_jns_ganti_jk" name="x_jns_ganti_jk" id="x_jns_ganti_jk" value="<?php echo ew_HtmlEncode($ganti_jk_d->jns_ganti_jk->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $ganti_jk_d->jk_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ganti_jk_d" data-field="x_jk_id" name="x_jk_id" id="x_jk_id" value="<?php echo ew_HtmlEncode($ganti_jk_d->jk_id->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $ganti_jk_d->pegawai_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ganti_jk_d" data-field="x_pegawai_id" name="x_pegawai_id" id="x_pegawai_id" value="<?php echo ew_HtmlEncode($ganti_jk_d->pegawai_id->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ganti_jk_d_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fganti_jk_dedit.Init();
</script>
<?php
$ganti_jk_d_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ganti_jk_d_edit->Page_Terminate();
?>
