...
$ganti_jk_pembagian = NULL;

//
// Table class for ganti_jk_pembagian
//
class cganti_jk_pembagian extends cTable {
	var $ganti_jk_id;
	var $pembagian1_id;
	var $pembagian2_id;
	var $pembagian3_id;
	...
	function __construct() {
		...
		$this->TableVar = 'ganti_jk_pembagian';
		$this->TableName = 'ganti_jk_pembagian';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ganti_jk_pembagian`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ganti_jk_id
		$this->ganti_jk_id = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_ganti_jk_id', 'ganti_jk_id', '`ganti_jk_id`', '`ganti_jk_id`', 3, -1, FALSE, '`ganti_jk_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pembagian1_id
		$this->pembagian1_id = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_pembagian1_id', 'pembagian1_id', '`pembagian1_id`', '`pembagian1_id`', 3, -1, FALSE, '`pembagian1_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pembagian2_id
		$this->pembagian2_id = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_pembagian2_id', 'pembagian2_id', '`pembagian2_id`', '`pembagian2_id`', 3, -1, FALSE, '`pembagian2_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pembagian3_id
		$this->pembagian3_id = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_pembagian3_id', 'pembagian3_id', '`pembagian3_id`', '`pembagian3_id`', 3, -1, FALSE, '`pembagian3_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_awal
		$this->tgl_awal = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_tgl_awal', 'tgl_awal', '`tgl_awal`', ew_CastDateFieldForLike('`tgl_awal`', 0, "DB"), 133, 0, FALSE, '`tgl_awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_akhir
		$this->tgl_akhir = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_tgl_akhir', 'tgl_akhir', '`tgl_akhir`', ew_CastDateFieldForLike('`tgl_akhir`', 0, "DB"), 133, 0, FALSE, '`tgl_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jk_id
		$this->jk_id = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_jk_id', 'jk_id', '`jk_id`', '`jk_id`', 3, -1, FALSE, '`jk_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new cField('ganti_jk_pembagian', 'ganti_jk_pembagian', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ganti_jk_pembagian`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ganti_jk_pembagianlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ganti_jk_pembagianview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ganti_jk_pembagianview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ganti_jk_pembagianadd.php?" . $this->UrlParm($parm);
		else
			$url = "ganti_jk_pembagianadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jk_pembagianedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jk_pembagianadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ganti_jk_pembagiandelete.php", $this->UrlParm());
	}
