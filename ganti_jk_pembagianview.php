...
$ganti_jk_pembagian_view = NULL; // Initialize page object first

class cganti_jk_pembagian_view extends cganti_jk_pembagian {
	...
	// Page object name
	var $PageObjName = 'ganti_jk_pembagian_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ganti_jk_id"] <> "") {
				...
				$sReturnUrl = "ganti_jk_pembagianlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "ganti_jk_pembagianlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "ganti_jk_pembagianlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($ganti_jk_pembagian_view)) $ganti_jk_pembagian_view = new cganti_jk_pembagian_view();

// Page init
$ganti_jk_pembagian_view->Page_Init();

// Page main
$ganti_jk_pembagian_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ganti_jk_pembagian_view->Page_Render();
?>
...
var CurrentForm = fganti_jk_pembagianview = new ew_Form("fganti_jk_pembagianview", "view");

// Form_CustomValidate event
fganti_jk_pembagianview.Form_CustomValidate = 
...
fganti_jk_pembagianview.ValidateRequired = true;
<?php } else { ?>
fganti_jk_pembagianview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($ganti_jk_pembagian->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$ganti_jk_pembagian_view->IsModal) { ?>
<?php if ($ganti_jk_pembagian->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $ganti_jk_pembagian_view->ExportOptions->Render("body") ?>
<?php
	foreach ($ganti_jk_pembagian_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$ganti_jk_pembagian_view->IsModal) { ?>
<?php if ($ganti_jk_pembagian->Export == "") { ?>
...
<?php } ?>
<?php $ganti_jk_pembagian_view->ShowPageHeader(); ?>
<?php
$ganti_jk_pembagian_view->ShowMessage();
?>
<form name="fganti_jk_pembagianview" id="fganti_jk_pembagianview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ganti_jk_pembagian_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ganti_jk_pembagian_view->Token ?>">
<?php } ?>
...
<?php if ($ganti_jk_pembagian->ganti_jk_id->Visible) { // ganti_jk_id ?>
	<tr id="r_ganti_jk_id">
		<td><span id="elh_ganti_jk_pembagian_ganti_jk_id"><?php echo $ganti_jk_pembagian->ganti_jk_id->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->ganti_jk_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->pembagian1_id->Visible) { // pembagian1_id ?>
	<tr id="r_pembagian1_id">
		<td><span id="elh_ganti_jk_pembagian_pembagian1_id"><?php echo $ganti_jk_pembagian->pembagian1_id->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->pembagian1_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->pembagian2_id->Visible) { // pembagian2_id ?>
	<tr id="r_pembagian2_id">
		<td><span id="elh_ganti_jk_pembagian_pembagian2_id"><?php echo $ganti_jk_pembagian->pembagian2_id->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->pembagian2_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->pembagian3_id->Visible) { // pembagian3_id ?>
	<tr id="r_pembagian3_id">
		<td><span id="elh_ganti_jk_pembagian_pembagian3_id"><?php echo $ganti_jk_pembagian->pembagian3_id->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->pembagian3_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->tgl_awal->Visible) { // tgl_awal ?>
	<tr id="r_tgl_awal">
		<td><span id="elh_ganti_jk_pembagian_tgl_awal"><?php echo $ganti_jk_pembagian->tgl_awal->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->tgl_awal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->tgl_akhir->Visible) { // tgl_akhir ?>
	<tr id="r_tgl_akhir">
		<td><span id="elh_ganti_jk_pembagian_tgl_akhir"><?php echo $ganti_jk_pembagian->tgl_akhir->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->tgl_akhir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->jk_id->Visible) { // jk_id ?>
	<tr id="r_jk_id">
		<td><span id="elh_ganti_jk_pembagian_jk_id"><?php echo $ganti_jk_pembagian->jk_id->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->jk_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ganti_jk_pembagian->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_ganti_jk_pembagian_keterangan"><?php echo $ganti_jk_pembagian->keterangan->FldCaption() ?></span></td>
...
<?php echo $ganti_jk_pembagian->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($ganti_jk_pembagian->Export == "") { ?>
<script type="text/javascript">
fganti_jk_pembagianview.Init();
</script>
<?php } ?>
<?php
$ganti_jk_pembagian_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($ganti_jk_pembagian->Export == "") { ?>
...
<?php
$ganti_jk_pembagian_view->Page_Terminate();
?>
