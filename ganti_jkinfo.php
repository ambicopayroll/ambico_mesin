...
//
// Table class for ganti_jk
//
class cganti_jk extends cTable {
	var $ganti_jk_id;
	var $jk_id1;
	var $jk_id2;
	var $tgl_awal;
	...
	function __construct() {
		...
		$this->TableVar = 'ganti_jk';
		$this->TableName = 'ganti_jk';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`ganti_jk`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ganti_jk_id
		$this->ganti_jk_id = new cField('ganti_jk', 'ganti_jk', 'x_ganti_jk_id', 'ganti_jk_id', '`ganti_jk_id`', '`ganti_jk_id`', 3, -1, FALSE, '`ganti_jk_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jk_id1
		$this->jk_id1 = new cField('ganti_jk', 'ganti_jk', 'x_jk_id1', 'jk_id1', '`jk_id1`', '`jk_id1`', 3, -1, FALSE, '`jk_id1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jk_id1->Sortable = TRUE; // Allow sort
		$this->jk_id1->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['jk_id1'] = &$this->jk_id1;

		// jk_id2
		$this->jk_id2 = new cField('ganti_jk', 'ganti_jk', 'x_jk_id2', 'jk_id2', '`jk_id2`', '`jk_id2`', 3, -1, FALSE, '`jk_id2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jk_id2->Sortable = TRUE; // Allow sort
		$this->jk_id2->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['jk_id2'] = &$this->jk_id2;

		// tgl_awal
		$this->tgl_awal = new cField('ganti_jk', 'ganti_jk', 'x_tgl_awal', 'tgl_awal', '`tgl_awal`', ew_CastDateFieldForLike('`tgl_awal`', 0, "DB"), 133, 0, FALSE, '`tgl_awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_akhir
		$this->tgl_akhir = new cField('ganti_jk', 'ganti_jk', 'x_tgl_akhir', 'tgl_akhir', '`tgl_akhir`', ew_CastDateFieldForLike('`tgl_akhir`', 0, "DB"), 133, 0, FALSE, '`tgl_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new cField('ganti_jk', 'ganti_jk', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`ganti_jk`";
	}
	...
	function SqlKeyFilter() {
		return "`ganti_jk_id` = @ganti_jk_id@";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("ganti_jkview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("ganti_jkview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "ganti_jkadd.php?" . $this->UrlParm($parm);
		else
			$url = "ganti_jkadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jkedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("ganti_jkadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("ganti_jkdelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["ganti_jk_id"]))
				$arKeys[] = ew_StripSlashes($_POST["ganti_jk_id"]);
			elseif (isset($_GET["ganti_jk_id"]))
				$arKeys[] = ew_StripSlashes($_GET["ganti_jk_id"]);
			else
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->ganti_jk_id->CurrentValue = $key;
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->jk_id1->EditValue = $this->jk_id1->CurrentValue;
		...
		$this->jk_id2->EditValue = $this->jk_id2->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->jk_id1->Exportable) $Doc->ExportCaption($this->jk_id1);
					if ($this->jk_id2->Exportable) $Doc->ExportCaption($this->jk_id2);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->jk_id1->Exportable) $Doc->ExportField($this->jk_id1);
						if ($this->jk_id2->Exportable) $Doc->ExportField($this->jk_id2);
