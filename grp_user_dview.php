...
$grp_user_d_view = NULL; // Initialize page object first

class cgrp_user_d_view extends cgrp_user_d {
	...
	// Page object name
	var $PageObjName = 'grp_user_d_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["com_id"] <> "") {
				...
				$sReturnUrl = "grp_user_dlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "grp_user_dlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "grp_user_dlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($grp_user_d_view)) $grp_user_d_view = new cgrp_user_d_view();

// Page init
$grp_user_d_view->Page_Init();

// Page main
$grp_user_d_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$grp_user_d_view->Page_Render();
?>
...
var CurrentForm = fgrp_user_dview = new ew_Form("fgrp_user_dview", "view");

// Form_CustomValidate event
fgrp_user_dview.Form_CustomValidate = 
...
fgrp_user_dview.ValidateRequired = true;
<?php } else { ?>
fgrp_user_dview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($grp_user_d->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$grp_user_d_view->IsModal) { ?>
<?php if ($grp_user_d->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $grp_user_d_view->ExportOptions->Render("body") ?>
<?php
	foreach ($grp_user_d_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$grp_user_d_view->IsModal) { ?>
<?php if ($grp_user_d->Export == "") { ?>
...
<?php } ?>
<?php $grp_user_d_view->ShowPageHeader(); ?>
<?php
$grp_user_d_view->ShowMessage();
?>
<form name="fgrp_user_dview" id="fgrp_user_dview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($grp_user_d_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $grp_user_d_view->Token ?>">
<?php } ?>
...
<?php if ($grp_user_d->grp_user_id->Visible) { // grp_user_id ?>
	<tr id="r_grp_user_id">
		<td><span id="elh_grp_user_d_grp_user_id"><?php echo $grp_user_d->grp_user_id->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->grp_user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->tree_id->Visible) { // tree_id ?>
	<tr id="r_tree_id">
		<td><span id="elh_grp_user_d_tree_id"><?php echo $grp_user_d->tree_id->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->tree_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->level_tree->Visible) { // level_tree ?>
	<tr id="r_level_tree">
		<td><span id="elh_grp_user_d_level_tree"><?php echo $grp_user_d->level_tree->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->level_tree->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->com_id->Visible) { // com_id ?>
	<tr id="r_com_id">
		<td><span id="elh_grp_user_d_com_id"><?php echo $grp_user_d->com_id->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->com_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->com_form->Visible) { // com_form ?>
	<tr id="r_com_form">
		<td><span id="elh_grp_user_d_com_form"><?php echo $grp_user_d->com_form->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->com_form->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->com_name->Visible) { // com_name ?>
	<tr id="r_com_name">
		<td><span id="elh_grp_user_d_com_name"><?php echo $grp_user_d->com_name->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->com_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->caption->Visible) { // caption ?>
	<tr id="r_caption">
		<td><span id="elh_grp_user_d_caption"><?php echo $grp_user_d->caption->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->caption->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->urutan->Visible) { // urutan ?>
	<tr id="r_urutan">
		<td><span id="elh_grp_user_d_urutan"><?php echo $grp_user_d->urutan->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->urutan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($grp_user_d->app_name->Visible) { // app_name ?>
	<tr id="r_app_name">
		<td><span id="elh_grp_user_d_app_name"><?php echo $grp_user_d->app_name->FldCaption() ?></span></td>
...
<?php echo $grp_user_d->app_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($grp_user_d->Export == "") { ?>
<script type="text/javascript">
fgrp_user_dview.Init();
</script>
<?php } ?>
<?php
$grp_user_d_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($grp_user_d->Export == "") { ?>
...
<?php
$grp_user_d_view->Page_Terminate();
?>
