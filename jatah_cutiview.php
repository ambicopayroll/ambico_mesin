...
$jatah_cuti_view = NULL; // Initialize page object first

class cjatah_cuti_view extends cjatah_cuti {
	...
	// Page object name
	var $PageObjName = 'jatah_cuti_view';
	...
	function __construct() {
		...
		if (@$_GET["jatah_c_mulai"] <> "") {
			$this->RecKey["jatah_c_mulai"] = $_GET["jatah_c_mulai"];
			$KeyUrl .= "&amp;jatah_c_mulai=" . urlencode($this->RecKey["jatah_c_mulai"]);
		}
		if (@$_GET["jatah_c_akhir"] <> "") {
			$this->RecKey["jatah_c_akhir"] = $_GET["jatah_c_akhir"];
			$KeyUrl .= "&amp;jatah_c_akhir=" . urlencode($this->RecKey["jatah_c_akhir"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["jatah_c_mulai"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["jatah_c_mulai"]);
		}
		if (@$_GET["jatah_c_akhir"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["jatah_c_akhir"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["pegawai_id"] <> "") {
				...
				$sReturnUrl = "jatah_cutilist.php"; // Return to list
			}
			if (@$_GET["jatah_c_mulai"] <> "") {
				$this->jatah_c_mulai->setQueryStringValue($_GET["jatah_c_mulai"]);
				$this->RecKey["jatah_c_mulai"] = $this->jatah_c_mulai->QueryStringValue;
			} elseif (@$_POST["jatah_c_mulai"] <> "") {
				$this->jatah_c_mulai->setFormValue($_POST["jatah_c_mulai"]);
				$this->RecKey["jatah_c_mulai"] = $this->jatah_c_mulai->FormValue;
			} else {
				$sReturnUrl = "jatah_cutilist.php"; // Return to list
			}
			if (@$_GET["jatah_c_akhir"] <> "") {
				$this->jatah_c_akhir->setQueryStringValue($_GET["jatah_c_akhir"]);
				$this->RecKey["jatah_c_akhir"] = $this->jatah_c_akhir->QueryStringValue;
			} elseif (@$_POST["jatah_c_akhir"] <> "") {
				$this->jatah_c_akhir->setFormValue($_POST["jatah_c_akhir"]);
				$this->RecKey["jatah_c_akhir"] = $this->jatah_c_akhir->FormValue;
			} else {
				$sReturnUrl = "jatah_cutilist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "jatah_cutilist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "jatah_cutilist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($jatah_cuti_view)) $jatah_cuti_view = new cjatah_cuti_view();

// Page init
$jatah_cuti_view->Page_Init();

// Page main
$jatah_cuti_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$jatah_cuti_view->Page_Render();
?>
...
var CurrentForm = fjatah_cutiview = new ew_Form("fjatah_cutiview", "view");

// Form_CustomValidate event
fjatah_cutiview.Form_CustomValidate = 
...
fjatah_cutiview.ValidateRequired = true;
<?php } else { ?>
fjatah_cutiview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($jatah_cuti->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$jatah_cuti_view->IsModal) { ?>
<?php if ($jatah_cuti->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $jatah_cuti_view->ExportOptions->Render("body") ?>
<?php
	foreach ($jatah_cuti_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$jatah_cuti_view->IsModal) { ?>
<?php if ($jatah_cuti->Export == "") { ?>
...
<?php } ?>
<?php $jatah_cuti_view->ShowPageHeader(); ?>
<?php
$jatah_cuti_view->ShowMessage();
?>
<form name="fjatah_cutiview" id="fjatah_cutiview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($jatah_cuti_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $jatah_cuti_view->Token ?>">
<?php } ?>
...
<?php if ($jatah_cuti->pegawai_id->Visible) { // pegawai_id ?>
	<tr id="r_pegawai_id">
		<td><span id="elh_jatah_cuti_pegawai_id"><?php echo $jatah_cuti->pegawai_id->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->pegawai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jatah_cuti->jatah_c_mulai->Visible) { // jatah_c_mulai ?>
	<tr id="r_jatah_c_mulai">
		<td><span id="elh_jatah_cuti_jatah_c_mulai"><?php echo $jatah_cuti->jatah_c_mulai->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->jatah_c_mulai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jatah_cuti->jatah_c_akhir->Visible) { // jatah_c_akhir ?>
	<tr id="r_jatah_c_akhir">
		<td><span id="elh_jatah_cuti_jatah_c_akhir"><?php echo $jatah_cuti->jatah_c_akhir->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->jatah_c_akhir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jatah_cuti->jatah_c_jml->Visible) { // jatah_c_jml ?>
	<tr id="r_jatah_c_jml">
		<td><span id="elh_jatah_cuti_jatah_c_jml"><?php echo $jatah_cuti->jatah_c_jml->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->jatah_c_jml->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jatah_cuti->jatah_c_hak_jml->Visible) { // jatah_c_hak_jml ?>
	<tr id="r_jatah_c_hak_jml">
		<td><span id="elh_jatah_cuti_jatah_c_hak_jml"><?php echo $jatah_cuti->jatah_c_hak_jml->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->jatah_c_hak_jml->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jatah_cuti->jatah_c_ambil_jml->Visible) { // jatah_c_ambil_jml ?>
	<tr id="r_jatah_c_ambil_jml">
		<td><span id="elh_jatah_cuti_jatah_c_ambil_jml"><?php echo $jatah_cuti->jatah_c_ambil_jml->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->jatah_c_ambil_jml->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jatah_cuti->jatah_c_utang_jml->Visible) { // jatah_c_utang_jml ?>
	<tr id="r_jatah_c_utang_jml">
		<td><span id="elh_jatah_cuti_jatah_c_utang_jml"><?php echo $jatah_cuti->jatah_c_utang_jml->FldCaption() ?></span></td>
...
<?php echo $jatah_cuti->jatah_c_utang_jml->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($jatah_cuti->Export == "") { ?>
<script type="text/javascript">
fjatah_cutiview.Init();
</script>
<?php } ?>
<?php
$jatah_cuti_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($jatah_cuti->Export == "") { ?>
...
<?php
$jatah_cuti_view->Page_Terminate();
?>
