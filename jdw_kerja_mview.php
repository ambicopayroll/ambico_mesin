...
$jdw_kerja_m_view = NULL; // Initialize page object first

class cjdw_kerja_m_view extends cjdw_kerja_m {
	...
	// Page object name
	var $PageObjName = 'jdw_kerja_m_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["jdw_kerja_m_id"] <> "") {
				...
				$sReturnUrl = "jdw_kerja_mlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "jdw_kerja_mlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "jdw_kerja_mlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($jdw_kerja_m_view)) $jdw_kerja_m_view = new cjdw_kerja_m_view();

// Page init
$jdw_kerja_m_view->Page_Init();

// Page main
$jdw_kerja_m_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$jdw_kerja_m_view->Page_Render();
?>
...
var CurrentForm = fjdw_kerja_mview = new ew_Form("fjdw_kerja_mview", "view");

// Form_CustomValidate event
fjdw_kerja_mview.Form_CustomValidate = 
...
fjdw_kerja_mview.ValidateRequired = true;
<?php } else { ?>
fjdw_kerja_mview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($jdw_kerja_m->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$jdw_kerja_m_view->IsModal) { ?>
<?php if ($jdw_kerja_m->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $jdw_kerja_m_view->ExportOptions->Render("body") ?>
<?php
	foreach ($jdw_kerja_m_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$jdw_kerja_m_view->IsModal) { ?>
<?php if ($jdw_kerja_m->Export == "") { ?>
...
<?php } ?>
<?php $jdw_kerja_m_view->ShowPageHeader(); ?>
<?php
$jdw_kerja_m_view->ShowMessage();
?>
<form name="fjdw_kerja_mview" id="fjdw_kerja_mview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($jdw_kerja_m_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $jdw_kerja_m_view->Token ?>">
<?php } ?>
...
<?php if ($jdw_kerja_m->jdw_kerja_m_id->Visible) { // jdw_kerja_m_id ?>
	<tr id="r_jdw_kerja_m_id">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_id"><?php echo $jdw_kerja_m->jdw_kerja_m_id->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->jdw_kerja_m_kode->Visible) { // jdw_kerja_m_kode ?>
	<tr id="r_jdw_kerja_m_kode">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_kode"><?php echo $jdw_kerja_m->jdw_kerja_m_kode->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_kode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->jdw_kerja_m_name->Visible) { // jdw_kerja_m_name ?>
	<tr id="r_jdw_kerja_m_name">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_name"><?php echo $jdw_kerja_m->jdw_kerja_m_name->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->jdw_kerja_m_keterangan->Visible) { // jdw_kerja_m_keterangan ?>
	<tr id="r_jdw_kerja_m_keterangan">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_keterangan"><?php echo $jdw_kerja_m->jdw_kerja_m_keterangan->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->jdw_kerja_m_periode->Visible) { // jdw_kerja_m_periode ?>
	<tr id="r_jdw_kerja_m_periode">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_periode"><?php echo $jdw_kerja_m->jdw_kerja_m_periode->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_periode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->jdw_kerja_m_mulai->Visible) { // jdw_kerja_m_mulai ?>
	<tr id="r_jdw_kerja_m_mulai">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_mulai"><?php echo $jdw_kerja_m->jdw_kerja_m_mulai->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_mulai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->jdw_kerja_m_type->Visible) { // jdw_kerja_m_type ?>
	<tr id="r_jdw_kerja_m_type">
		<td><span id="elh_jdw_kerja_m_jdw_kerja_m_type"><?php echo $jdw_kerja_m->jdw_kerja_m_type->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->jdw_kerja_m_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jdw_kerja_m->use_sama->Visible) { // use_sama ?>
	<tr id="r_use_sama">
		<td><span id="elh_jdw_kerja_m_use_sama"><?php echo $jdw_kerja_m->use_sama->FldCaption() ?></span></td>
...
<?php echo $jdw_kerja_m->use_sama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($jdw_kerja_m->Export == "") { ?>
<script type="text/javascript">
fjdw_kerja_mview.Init();
</script>
<?php } ?>
<?php
$jdw_kerja_m_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($jdw_kerja_m->Export == "") { ?>
...
<?php
$jdw_kerja_m_view->Page_Terminate();
?>
