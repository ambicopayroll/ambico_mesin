...
$pembagian1_edit = NULL; // Initialize page object first

class cpembagian1_edit extends cpembagian1 {
	...
	// Page object name
	var $PageObjName = 'pembagian1_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// pembagian1_ket
			$this->pembagian1_ket->SetDbValueDef($rsnew, $this->pembagian1_ket->CurrentValue, NULL, $this->pembagian1_ket->ReadOnly);
...
// Create page object
if (!isset($pembagian1_edit)) $pembagian1_edit = new cpembagian1_edit();

// Page init
$pembagian1_edit->Page_Init();

// Page main
$pembagian1_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pembagian1_edit->Page_Render();
?>
...
var CurrentForm = fpembagian1edit = new ew_Form("fpembagian1edit", "edit");

// Validate form
fpembagian1edit.Validate = function() {
...
fpembagian1edit.Form_CustomValidate = 
...
fpembagian1edit.ValidateRequired = true;
<?php } else { ?>
fpembagian1edit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $pembagian1_edit->ShowPageHeader(); ?>
<?php
...
<script type="text/javascript">
fpembagian1edit.Init();
</script>
<?php
$pembagian1_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pembagian1_edit->Page_Terminate();
?>
