...
$pembagian2_edit = NULL; // Initialize page object first

class cpembagian2_edit extends cpembagian2 {
	...
	// Page object name
	var $PageObjName = 'pembagian2_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->pembagian2_id->CurrentValue == "") {
			$this->Page_Terminate("pembagian2list.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($pembagian2_edit)) $pembagian2_edit = new cpembagian2_edit();

// Page init
$pembagian2_edit->Page_Init();

// Page main
$pembagian2_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pembagian2_edit->Page_Render();
?>
...
var CurrentForm = fpembagian2edit = new ew_Form("fpembagian2edit", "edit");

// Validate form
fpembagian2edit.Validate = function() {
...
fpembagian2edit.Form_CustomValidate = 
...
fpembagian2edit.ValidateRequired = true;
<?php } else { ?>
fpembagian2edit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $pembagian2_edit->ShowPageHeader(); ?>
<?php
$pembagian2_edit->ShowMessage();
?>
<form name="fpembagian2edit" id="fpembagian2edit" class="<?php echo $pembagian2_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pembagian2_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pembagian2_edit->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pembagian2_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fpembagian2edit.Init();
</script>
<?php
$pembagian2_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pembagian2_edit->Page_Terminate();
?>
