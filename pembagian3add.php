...
$pembagian3_add = NULL; // Initialize page object first

class cpembagian3_add extends cpembagian3 {
	...
	// Page object name
	var $PageObjName = 'pembagian3_add';
	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['pembagian3_id']) == "") {
...
// Create page object
if (!isset($pembagian3_add)) $pembagian3_add = new cpembagian3_add();

// Page init
$pembagian3_add->Page_Init();

// Page main
$pembagian3_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pembagian3_add->Page_Render();
?>
...
var CurrentForm = fpembagian3add = new ew_Form("fpembagian3add", "add");

// Validate form
fpembagian3add.Validate = function() {
...
fpembagian3add.Form_CustomValidate = 
...
fpembagian3add.ValidateRequired = true;
<?php } else { ?>
fpembagian3add.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $pembagian3_add->ShowPageHeader(); ?>
<?php
$pembagian3_add->ShowMessage();
?>
<form name="fpembagian3add" id="fpembagian3add" class="<?php echo $pembagian3_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pembagian3_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pembagian3_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="pembagian3" data-field="x_pembagian3_id" name="x_pembagian3_id" id="x_pembagian3_id" size="30" placeholder="<?php echo ew_HtmlEncode($pembagian3->pembagian3_id->getPlaceHolder()) ?>" value="<?php echo $pembagian3->pembagian3_id->EditValue ?>"<?php echo $pembagian3->pembagian3_id->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pembagian3_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
