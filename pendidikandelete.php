...
fpendidikandelete.ValidateRequired = true;
<?php } else { ?>
fpendidikandelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($pendidikan->pend_id->Visible) { // pend_id ?>
		<th><span id="elh_pendidikan_pend_id" class="pendidikan_pend_id"><?php echo $pendidikan->pend_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pendidikan->pend_name->Visible) { // pend_name ?>
		<th><span id="elh_pendidikan_pend_name" class="pendidikan_pend_name"><?php echo $pendidikan->pend_name->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($pendidikan->pend_id->Visible) { // pend_id ?>
		<td<?php echo $pendidikan->pend_id->CellAttributes() ?>>
<span id="el<?php echo $pendidikan_delete->RowCnt ?>_pendidikan_pend_id" class="pendidikan_pend_id">
...
<?php } ?>
<?php if ($pendidikan->pend_name->Visible) { // pend_name ?>
		<td<?php echo $pendidikan->pend_name->CellAttributes() ?>>
<span id="el<?php echo $pendidikan_delete->RowCnt ?>_pendidikan_pend_name" class="pendidikan_pend_name">
