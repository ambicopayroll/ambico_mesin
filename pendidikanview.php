...
class cpendidikan_view extends cpendidikan {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["pend_id"] <> "") {
			$this->RecKey["pend_id"] = $_GET["pend_id"];
			$KeyUrl .= "&amp;pend_id=" . urlencode($this->RecKey["pend_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["pend_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["pend_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["pend_id"] <> "") {
				...
				$this->RecKey["pend_id"] = $this->pend_id->QueryStringValue;
			} elseif (@$_POST["pend_id"] <> "") {
				$this->pend_id->setFormValue($_POST["pend_id"]);
				$this->RecKey["pend_id"] = $this->pend_id->FormValue;
			} else {
...
fpendidikanview.ValidateRequired = true;
<?php } else { ?>
fpendidikanview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($pendidikan->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$pendidikan_view->IsModal) { ?>
<?php if ($pendidikan->Export == "") { ?>
...
<?php if ($pendidikan->pend_id->Visible) { // pend_id ?>
	<tr id="r_pend_id">
		<td><span id="elh_pendidikan_pend_id"><?php echo $pendidikan->pend_id->FldCaption() ?></span></td>
...
<?php echo $pendidikan->pend_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pendidikan->pend_name->Visible) { // pend_name ?>
	<tr id="r_pend_name">
		<td><span id="elh_pendidikan_pend_name"><?php echo $pendidikan->pend_name->FldCaption() ?></span></td>
...
<?php echo $pendidikan->pend_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
