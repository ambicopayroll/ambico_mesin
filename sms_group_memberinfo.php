...
$sms_group_member = NULL;

//
// Table class for sms_group_member
//
class csms_group_member extends cTable {
	var $group_id;
	var $pegawai_pin;
	...
	function __construct() {
		...
		$this->TableVar = 'sms_group_member';
		$this->TableName = 'sms_group_member';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`sms_group_member`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// group_id
		$this->group_id = new cField('sms_group_member', 'sms_group_member', 'x_group_id', 'group_id', '`group_id`', '`group_id`', 3, -1, FALSE, '`group_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai_pin
		$this->pegawai_pin = new cField('sms_group_member', 'sms_group_member', 'x_pegawai_pin', 'pegawai_pin', '`pegawai_pin`', '`pegawai_pin`', 200, -1, FALSE, '`pegawai_pin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`sms_group_member`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "sms_group_memberlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("sms_group_memberview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("sms_group_memberview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "sms_group_memberadd.php?" . $this->UrlParm($parm);
		else
			$url = "sms_group_memberadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("sms_group_memberedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("sms_group_memberadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("sms_group_memberdelete.php", $this->UrlParm());
	}
