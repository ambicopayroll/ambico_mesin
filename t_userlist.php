...
<?php if ($t_user->user_id->Visible) { // user_id ?>
	...
	<?php } else { ?>
		<th data-name="user_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t_user->SortUrl($t_user->user_id) ?>',2);"><div id="elh_t_user_user_id" class="t_user_user_id">
