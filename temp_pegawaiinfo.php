...
//
// Table class for temp_pegawai
//
class ctemp_pegawai extends cTable {
	var $pegawai_id;
	...
	function __construct() {
		...
		$this->TableVar = 'temp_pegawai';
		$this->TableName = 'temp_pegawai';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`temp_pegawai`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// pegawai_id
		$this->pegawai_id = new cField('temp_pegawai', 'temp_pegawai', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 3, -1, FALSE, '`pegawai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`temp_pegawai`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("temp_pegawaiview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("temp_pegawaiview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "temp_pegawaiadd.php?" . $this->UrlParm($parm);
		else
			$url = "temp_pegawaiadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("temp_pegawaiedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("temp_pegawaiadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("temp_pegawaidelete.php", $this->UrlParm());
	}
