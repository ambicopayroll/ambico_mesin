...
//
// Table class for z_pay_com
//
class cz_pay_com extends cTable {
	var $com_id;
	var $com_kode;
	var $com_name;
	var $type_com;
	...
	function __construct() {
		...
		$this->TableVar = 'z_pay_com';
		$this->TableName = 'z_pay_com';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`z_pay_com`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// com_id
		$this->com_id = new cField('z_pay_com', 'z_pay_com', 'x_com_id', 'com_id', '`com_id`', '`com_id`', 2, -1, FALSE, '`com_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// com_kode
		$this->com_kode = new cField('z_pay_com', 'z_pay_com', 'x_com_kode', 'com_kode', '`com_kode`', '`com_kode`', 200, -1, FALSE, '`com_kode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->com_kode->Sortable = TRUE; // Allow sort
		$this->fields['com_kode'] = &$this->com_kode;

		// com_name
		$this->com_name = new cField('z_pay_com', 'z_pay_com', 'x_com_name', 'com_name', '`com_name`', '`com_name`', 200, -1, FALSE, '`com_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->com_name->Sortable = TRUE; // Allow sort
		$this->fields['com_name'] = &$this->com_name;

		// type_com
		$this->type_com = new cField('z_pay_com', 'z_pay_com', 'x_type_com', 'type_com', '`type_com`', '`type_com`', 16, -1, FALSE, '`type_com`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->type_com->Sortable = TRUE; // Allow sort
		$this->type_com->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['type_com'] = &$this->type_com;

		// fluctuate
		$this->fluctuate = new cField('z_pay_com', 'z_pay_com', 'x_fluctuate', 'fluctuate', '`fluctuate`', '`fluctuate`', 16, -1, FALSE, '`fluctuate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fluctuate->Sortable = TRUE; // Allow sort
		$this->fluctuate->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['fluctuate'] = &$this->fluctuate;

		// no_urut
		$this->no_urut = new cField('z_pay_com', 'z_pay_com', 'x_no_urut', 'no_urut', '`no_urut`', '`no_urut`', 2, -1, FALSE, '`no_urut`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// param
		$this->param = new cField('z_pay_com', 'z_pay_com', 'x_param', 'param', '`param`', '`param`', 16, -1, FALSE, '`param`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->param->Sortable = TRUE; // Allow sort
		$this->param->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['param'] = &$this->param;

		// hitung
		$this->hitung = new cField('z_pay_com', 'z_pay_com', 'x_hitung', 'hitung', '`hitung`', '`hitung`', 16, -1, FALSE, '`hitung`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// dibayar
		$this->dibayar = new cField('z_pay_com', 'z_pay_com', 'x_dibayar', 'dibayar', '`dibayar`', '`dibayar`', 16, -1, FALSE, '`dibayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->dibayar->Sortable = TRUE; // Allow sort
		$this->dibayar->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['dibayar'] = &$this->dibayar;

		// cara_bayar
		$this->cara_bayar = new cField('z_pay_com', 'z_pay_com', 'x_cara_bayar', 'cara_bayar', '`cara_bayar`', '`cara_bayar`', 16, -1, FALSE, '`cara_bayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pinjaman
		$this->pinjaman = new cField('z_pay_com', 'z_pay_com', 'x_pinjaman', 'pinjaman', '`pinjaman`', '`pinjaman`', 16, -1, FALSE, '`pinjaman`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pinjaman->Sortable = TRUE; // Allow sort
		$this->pinjaman->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pinjaman'] = &$this->pinjaman;

		// lastupdate_date
		$this->lastupdate_date = new cField('z_pay_com', 'z_pay_com', 'x_lastupdate_date', 'lastupdate_date', '`lastupdate_date`', ew_CastDateFieldForLike('`lastupdate_date`', 0, "DB"), 135, 0, FALSE, '`lastupdate_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// lastupdate_user
		$this->lastupdate_user = new cField('z_pay_com', 'z_pay_com', 'x_lastupdate_user', 'lastupdate_user', '`lastupdate_user`', '`lastupdate_user`', 200, -1, FALSE, '`lastupdate_user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`z_pay_com`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("z_pay_comview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("z_pay_comview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "z_pay_comadd.php?" . $this->UrlParm($parm);
		else
			$url = "z_pay_comadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("z_pay_comedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("z_pay_comadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("z_pay_comdelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["com_id"]))
				$arKeys[] = ew_StripSlashes($_POST["com_id"]);
			elseif (isset($_GET["com_id"]))
				$arKeys[] = ew_StripSlashes($_GET["com_id"]);
			else
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->com_kode->EditValue = $this->com_kode->CurrentValue;
		...
		$this->type_com->EditValue = $this->type_com->CurrentValue;
		...
		$this->fluctuate->EditValue = $this->fluctuate->CurrentValue;
		...
		$this->param->EditValue = $this->param->CurrentValue;
		...
		$this->dibayar->EditValue = $this->dibayar->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->com_kode->Exportable) $Doc->ExportCaption($this->com_kode);
					if ($this->com_name->Exportable) $Doc->ExportCaption($this->com_name);
					if ($this->type_com->Exportable) $Doc->ExportCaption($this->type_com);
					if ($this->fluctuate->Exportable) $Doc->ExportCaption($this->fluctuate);
					if ($this->no_urut->Exportable) $Doc->ExportCaption($this->no_urut);
					if ($this->param->Exportable) $Doc->ExportCaption($this->param);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->com_kode->Exportable) $Doc->ExportField($this->com_kode);
						if ($this->com_name->Exportable) $Doc->ExportField($this->com_name);
						if ($this->type_com->Exportable) $Doc->ExportField($this->type_com);
						if ($this->fluctuate->Exportable) $Doc->ExportField($this->fluctuate);
						if ($this->no_urut->Exportable) $Doc->ExportField($this->no_urut);
						if ($this->param->Exportable) $Doc->ExportField($this->param);
