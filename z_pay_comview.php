...
$z_pay_com_view = NULL; // Initialize page object first

class cz_pay_com_view extends cz_pay_com {
	...
	// Page object name
	var $PageObjName = 'z_pay_com_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["com_id"] <> "") {
				...
				$sReturnUrl = "z_pay_comlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "z_pay_comlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "z_pay_comlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($z_pay_com_view)) $z_pay_com_view = new cz_pay_com_view();

// Page init
$z_pay_com_view->Page_Init();

// Page main
$z_pay_com_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$z_pay_com_view->Page_Render();
?>
...
var CurrentForm = fz_pay_comview = new ew_Form("fz_pay_comview", "view");

// Form_CustomValidate event
fz_pay_comview.Form_CustomValidate = 
...
fz_pay_comview.ValidateRequired = true;
<?php } else { ?>
fz_pay_comview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($z_pay_com->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$z_pay_com_view->IsModal) { ?>
<?php if ($z_pay_com->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $z_pay_com_view->ExportOptions->Render("body") ?>
<?php
	foreach ($z_pay_com_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$z_pay_com_view->IsModal) { ?>
<?php if ($z_pay_com->Export == "") { ?>
...
<?php } ?>
<?php $z_pay_com_view->ShowPageHeader(); ?>
<?php
$z_pay_com_view->ShowMessage();
?>
<form name="fz_pay_comview" id="fz_pay_comview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($z_pay_com_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $z_pay_com_view->Token ?>">
<?php } ?>
...
<?php if ($z_pay_com->com_id->Visible) { // com_id ?>
	<tr id="r_com_id">
		<td><span id="elh_z_pay_com_com_id"><?php echo $z_pay_com->com_id->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->com_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->com_kode->Visible) { // com_kode ?>
	<tr id="r_com_kode">
		<td><span id="elh_z_pay_com_com_kode"><?php echo $z_pay_com->com_kode->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->com_kode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->com_name->Visible) { // com_name ?>
	<tr id="r_com_name">
		<td><span id="elh_z_pay_com_com_name"><?php echo $z_pay_com->com_name->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->com_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->type_com->Visible) { // type_com ?>
	<tr id="r_type_com">
		<td><span id="elh_z_pay_com_type_com"><?php echo $z_pay_com->type_com->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->type_com->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->fluctuate->Visible) { // fluctuate ?>
	<tr id="r_fluctuate">
		<td><span id="elh_z_pay_com_fluctuate"><?php echo $z_pay_com->fluctuate->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->fluctuate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->no_urut->Visible) { // no_urut ?>
	<tr id="r_no_urut">
		<td><span id="elh_z_pay_com_no_urut"><?php echo $z_pay_com->no_urut->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->no_urut->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->param->Visible) { // param ?>
	<tr id="r_param">
		<td><span id="elh_z_pay_com_param"><?php echo $z_pay_com->param->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->param->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->hitung->Visible) { // hitung ?>
	<tr id="r_hitung">
		<td><span id="elh_z_pay_com_hitung"><?php echo $z_pay_com->hitung->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->hitung->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->dibayar->Visible) { // dibayar ?>
	<tr id="r_dibayar">
		<td><span id="elh_z_pay_com_dibayar"><?php echo $z_pay_com->dibayar->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->dibayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->cara_bayar->Visible) { // cara_bayar ?>
	<tr id="r_cara_bayar">
		<td><span id="elh_z_pay_com_cara_bayar"><?php echo $z_pay_com->cara_bayar->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->cara_bayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->pinjaman->Visible) { // pinjaman ?>
	<tr id="r_pinjaman">
		<td><span id="elh_z_pay_com_pinjaman"><?php echo $z_pay_com->pinjaman->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->pinjaman->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->lastupdate_date->Visible) { // lastupdate_date ?>
	<tr id="r_lastupdate_date">
		<td><span id="elh_z_pay_com_lastupdate_date"><?php echo $z_pay_com->lastupdate_date->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->lastupdate_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_com->lastupdate_user->Visible) { // lastupdate_user ?>
	<tr id="r_lastupdate_user">
		<td><span id="elh_z_pay_com_lastupdate_user"><?php echo $z_pay_com->lastupdate_user->FldCaption() ?></span></td>
...
<?php echo $z_pay_com->lastupdate_user->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
