...
$z_pay_grp_emp_edit = NULL; // Initialize page object first

class cz_pay_grp_emp_edit extends cz_pay_grp_emp {
	...
	// Page object name
	var $PageObjName = 'z_pay_grp_emp_edit';
	...
	function Page_Main() {
		...
		if ($this->grp_id->CurrentValue == "") {
			$this->Page_Terminate("z_pay_grp_emplist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->no_rek->SetDbValueDef($rsnew, $this->no_rek->CurrentValue, "", $this->no_rek->ReadOnly);
...
// Create page object
if (!isset($z_pay_grp_emp_edit)) $z_pay_grp_emp_edit = new cz_pay_grp_emp_edit();

// Page init
$z_pay_grp_emp_edit->Page_Init();

// Page main
$z_pay_grp_emp_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$z_pay_grp_emp_edit->Page_Render();
?>
...
var CurrentForm = fz_pay_grp_empedit = new ew_Form("fz_pay_grp_empedit", "edit");

// Validate form
fz_pay_grp_empedit.Validate = function() {
...
fz_pay_grp_empedit.Form_CustomValidate = 
...
fz_pay_grp_empedit.ValidateRequired = true;
<?php } else { ?>
fz_pay_grp_empedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$z_pay_grp_emp_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $z_pay_grp_emp_edit->ShowPageHeader(); ?>
<?php
$z_pay_grp_emp_edit->ShowMessage();
?>
<form name="fz_pay_grp_empedit" id="fz_pay_grp_empedit" class="<?php echo $z_pay_grp_emp_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($z_pay_grp_emp_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $z_pay_grp_emp_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $z_pay_grp_emp->grp_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="z_pay_grp_emp" data-field="x_grp_id" name="x_grp_id" id="x_grp_id" value="<?php echo ew_HtmlEncode($z_pay_grp_emp->grp_id->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $z_pay_grp_emp->emp_id_auto->EditValue ?></p></span>
</span>
<input type="hidden" data-table="z_pay_grp_emp" data-field="x_emp_id_auto" name="x_emp_id_auto" id="x_emp_id_auto" value="<?php echo ew_HtmlEncode($z_pay_grp_emp->emp_id_auto->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $z_pay_grp_emp_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fz_pay_grp_empedit.Init();
</script>
<?php
$z_pay_grp_emp_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$z_pay_grp_emp_edit->Page_Terminate();
?>
