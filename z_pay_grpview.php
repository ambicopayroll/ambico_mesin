...
$z_pay_grp_view = NULL; // Initialize page object first

class cz_pay_grp_view extends cz_pay_grp {
	...
	// Page object name
	var $PageObjName = 'z_pay_grp_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["grp_id"] <> "") {
				...
				$sReturnUrl = "z_pay_grplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "z_pay_grplist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "z_pay_grplist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($z_pay_grp_view)) $z_pay_grp_view = new cz_pay_grp_view();

// Page init
$z_pay_grp_view->Page_Init();

// Page main
$z_pay_grp_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$z_pay_grp_view->Page_Render();
?>
...
var CurrentForm = fz_pay_grpview = new ew_Form("fz_pay_grpview", "view");

// Form_CustomValidate event
fz_pay_grpview.Form_CustomValidate = 
...
fz_pay_grpview.ValidateRequired = true;
<?php } else { ?>
fz_pay_grpview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($z_pay_grp->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$z_pay_grp_view->IsModal) { ?>
<?php if ($z_pay_grp->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $z_pay_grp_view->ExportOptions->Render("body") ?>
<?php
	foreach ($z_pay_grp_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$z_pay_grp_view->IsModal) { ?>
<?php if ($z_pay_grp->Export == "") { ?>
...
<?php } ?>
<?php $z_pay_grp_view->ShowPageHeader(); ?>
<?php
$z_pay_grp_view->ShowMessage();
?>
<form name="fz_pay_grpview" id="fz_pay_grpview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($z_pay_grp_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $z_pay_grp_view->Token ?>">
<?php } ?>
...
<?php if ($z_pay_grp->grp_id->Visible) { // grp_id ?>
	<tr id="r_grp_id">
		<td><span id="elh_z_pay_grp_grp_id"><?php echo $z_pay_grp->grp_id->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->grp_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->kode_grp->Visible) { // kode_grp ?>
	<tr id="r_kode_grp">
		<td><span id="elh_z_pay_grp_kode_grp"><?php echo $z_pay_grp->kode_grp->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->kode_grp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->grp_name->Visible) { // grp_name ?>
	<tr id="r_grp_name">
		<td><span id="elh_z_pay_grp_grp_name"><?php echo $z_pay_grp->grp_name->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->grp_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->use_pengurang->Visible) { // use_pengurang ?>
	<tr id="r_use_pengurang">
		<td><span id="elh_z_pay_grp_use_pengurang"><?php echo $z_pay_grp->use_pengurang->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->use_pengurang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->type_pengurang->Visible) { // type_pengurang ?>
	<tr id="r_type_pengurang">
		<td><span id="elh_z_pay_grp_type_pengurang"><?php echo $z_pay_grp->type_pengurang->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->type_pengurang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->pengurang_persen->Visible) { // pengurang_persen ?>
	<tr id="r_pengurang_persen">
		<td><span id="elh_z_pay_grp_pengurang_persen"><?php echo $z_pay_grp->pengurang_persen->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->pengurang_persen->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->lastupdate_date->Visible) { // lastupdate_date ?>
	<tr id="r_lastupdate_date">
		<td><span id="elh_z_pay_grp_lastupdate_date"><?php echo $z_pay_grp->lastupdate_date->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->lastupdate_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($z_pay_grp->lastupdate_user->Visible) { // lastupdate_user ?>
	<tr id="r_lastupdate_user">
		<td><span id="elh_z_pay_grp_lastupdate_user"><?php echo $z_pay_grp->lastupdate_user->FldCaption() ?></span></td>
...
<?php echo $z_pay_grp->lastupdate_user->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
