...
$zx_kredit_d_view = NULL; // Initialize page object first

class czx_kredit_d_view extends czx_kredit_d {
	...
	// Page object name
	var $PageObjName = 'zx_kredit_d_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_kredit"] <> "") {
				...
				$sReturnUrl = "zx_kredit_dlist.php"; // Return to list
			}
			if (@$_GET["no_urut"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "zx_kredit_dlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "zx_kredit_dlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($zx_kredit_d_view)) $zx_kredit_d_view = new czx_kredit_d_view();

// Page init
$zx_kredit_d_view->Page_Init();

// Page main
$zx_kredit_d_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$zx_kredit_d_view->Page_Render();
?>
...
var CurrentForm = fzx_kredit_dview = new ew_Form("fzx_kredit_dview", "view");

// Form_CustomValidate event
fzx_kredit_dview.Form_CustomValidate = 
...
fzx_kredit_dview.ValidateRequired = true;
<?php } else { ?>
fzx_kredit_dview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($zx_kredit_d->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$zx_kredit_d_view->IsModal) { ?>
<?php if ($zx_kredit_d->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $zx_kredit_d_view->ExportOptions->Render("body") ?>
<?php
	foreach ($zx_kredit_d_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$zx_kredit_d_view->IsModal) { ?>
<?php if ($zx_kredit_d->Export == "") { ?>
...
<?php } ?>
<?php $zx_kredit_d_view->ShowPageHeader(); ?>
<?php
$zx_kredit_d_view->ShowMessage();
?>
<form name="fzx_kredit_dview" id="fzx_kredit_dview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($zx_kredit_d_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $zx_kredit_d_view->Token ?>">
<?php } ?>
...
<?php if ($zx_kredit_d->id_kredit->Visible) { // id_kredit ?>
	<tr id="r_id_kredit">
		<td><span id="elh_zx_kredit_d_id_kredit"><?php echo $zx_kredit_d->id_kredit->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->id_kredit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->no_urut->Visible) { // no_urut ?>
	<tr id="r_no_urut">
		<td><span id="elh_zx_kredit_d_no_urut"><?php echo $zx_kredit_d->no_urut->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->no_urut->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->tgl_jt->Visible) { // tgl_jt ?>
	<tr id="r_tgl_jt">
		<td><span id="elh_zx_kredit_d_tgl_jt"><?php echo $zx_kredit_d->tgl_jt->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->tgl_jt->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->saldo_aw->Visible) { // saldo_aw ?>
	<tr id="r_saldo_aw">
		<td><span id="elh_zx_kredit_d_saldo_aw"><?php echo $zx_kredit_d->saldo_aw->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->saldo_aw->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->debet->Visible) { // debet ?>
	<tr id="r_debet">
		<td><span id="elh_zx_kredit_d_debet"><?php echo $zx_kredit_d->debet->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->debet->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->angs_pokok->Visible) { // angs_pokok ?>
	<tr id="r_angs_pokok">
		<td><span id="elh_zx_kredit_d_angs_pokok"><?php echo $zx_kredit_d->angs_pokok->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->angs_pokok->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->bunga->Visible) { // bunga ?>
	<tr id="r_bunga">
		<td><span id="elh_zx_kredit_d_bunga"><?php echo $zx_kredit_d->bunga->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->bunga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->saldo_akh->Visible) { // saldo_akh ?>
	<tr id="r_saldo_akh">
		<td><span id="elh_zx_kredit_d_saldo_akh"><?php echo $zx_kredit_d->saldo_akh->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->saldo_akh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->proses_bayar->Visible) { // proses_bayar ?>
	<tr id="r_proses_bayar">
		<td><span id="elh_zx_kredit_d_proses_bayar"><?php echo $zx_kredit_d->proses_bayar->FldCaption() ?></span></td>
...
<?php echo $zx_kredit_d->proses_bayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($zx_kredit_d->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_zx_kredit_d_keterangan"><?php echo $zx_kredit_d->keterangan->FldCaption() ?></span></td>
		<td data-name="keterangan"<?php echo $zx_kredit_d->keterangan->CellAttributes() ?>>
<span id="el_zx_kredit_d_keterangan">
<span<?php echo $zx_kredit_d->keterangan->ViewAttributes() ?>>
<?php echo $zx_kredit_d->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($zx_kredit_d->Export == "") { ?>
<script type="text/javascript">
fzx_kredit_dview.Init();
</script>
<?php } ?>
<?php
$zx_kredit_d_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($zx_kredit_d->Export == "") { ?>
...
<?php
$zx_kredit_d_view->Page_Terminate();
?>
